...
public class ProcessPhaseParameterSensorProfile : Profile
{
    public ProcessPhaseParameterSensorProfile()
    {
        CreateMap<ProcessPhaseParameterSensor, ProcessPhaseParameterSensorResult>()
            ...
            .ForMember(d => d.WineBatchId, o => o.MapFrom(s => s.WineMaterialBatchGrapeSortPhaseParameter != null ? s.WineMaterialBatchGrapeSortPhaseParameter.WineMaterialBatchGrapeSortPhase.WineMaterialBatchId : null))
            .ForMember(d => d.WineBatchName, o => o.MapFrom(s => s.WineMaterialBatchGrapeSortPhaseParameter != null ? s.WineMaterialBatchGrapeSortPhaseParameter.WineMaterialBatchGrapeSortPhase.WineMaterialBatch.Name : null));
    }
}