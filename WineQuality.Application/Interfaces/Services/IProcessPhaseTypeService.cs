...
public interface IProcessPhaseService {
    Task<ProcessPhaseDetailsResult> GetByIdAsync(string id, CancellationToken cancellationToken = default);
    ...
    Task EditPhaseParametersAsync(EditPhaseParametersRequest request,
